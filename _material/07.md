...
Transaktioita ei ole eristetty toisistaan. On mahdollista, että transaktio näkee toisen transaktion tekemän muutoksen, vaikka toista transaktiota ei ole viety loppuun.

**Taso 2 (read committed)**

Transaktio saa nähdä toisen transaktion tekemän muutoksen vain, jos toinen transaktio on viety loppuun.

**Taso 3 (repeatable read)**

Transaktio saa nähdä toisen transaktion tekemän muutoksen vain, jos toinen transaktio on viety loppuun. Lisäksi jos transaktion aikana luetaan saman rivin sisältö useita kertoja, rivin sisältö ei saa muuttua toisen transaktion takia.

**Taso 4 (serializable)**

Transaktiot ovat täysin eristettyjä toisistaan. Transaktioissa olevat komennot käyttäytyvät samoin kuin jos transaktiot olisi suoritettu peräkkäin yksi kerrallaan jossain järjestyksessä.
